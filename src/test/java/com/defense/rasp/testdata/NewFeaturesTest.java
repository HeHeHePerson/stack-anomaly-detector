...
public class NewFeaturesTest {
    ...
    private static void testNewHookPoints() {
        ...
        System.out.println("  插桩类:");
        for (String clazz : hookedClasses) {
            System.out.println("    - " + clazz);
        }
        System.out.println("  已移除无效 Hook: BufferedReader, Properties, BufferedInputStream");
        System.out.println("  (这些类的 toString() 不返回文件路径，依赖底层流 Hook 即可)");
        System.out.println("  ✓ 所有有效 Hook 点已注册\n");
    }
